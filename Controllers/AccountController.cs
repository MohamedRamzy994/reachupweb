...
namespace AppletSoftware.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(ManagersViewModel model,string language)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        AspNetUsersInfoPlu Entity = new AspNetUsersInfoPlu();

                        Entity.UInfoPlus_Id = Guid.NewGuid().ToString();
                        Entity.UInfoPlus_Fname_Ar = model.UInfoPlus_Fname_Ar;
                        Entity.UInfoPlus_Fname_En = model.UInfoPlus_Fname_En;
                        Entity.UInfo_Lname_Ar = model.UInfo_Lname_Ar;
                        Entity.UInfo_Lname_En = model.UInfo_Lname_En;
                        Entity.UInfo_DateTime = DateTime.Now;
                        Entity.UInfo_Photo = "team-1.jpg";
                        Entity.Id = user.Id ;
                        Entity.UInfo_Publisher = User.Identity.GetUserId();

                        Context.AspNetUsersInfoPlus.Add(Entity);
                        Context.SaveChanges();
                        AspNetNotification Notify = new AspNetNotification();
                        Notify.Notify_Id = Guid.NewGuid().ToString();
                        Notify.Notify_Title = "Add New Manager";
                    ...
                    return RedirectToAction("Managers", "Manage");
